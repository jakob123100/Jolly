...
def process_movement_commands(commands):
    for command in commands:
        if(command[0] == "Vänster"):
            servo_con.move_left_arm(command[1] * servo_con.SERVO_RANGE_OF_MOTION, command[1])
        elif(command[0] == "Höger"):
            servo_con.move_right_arm(command[1] * servo_con.SERVO_RANGE_OF_MOTION, command[1])
        elif(command[0] == "HUVUD"):
            servo_con.move_head(command[1] * servo_con.SERVO_RANGE_OF_MOTION, command[1])
